...
from .specifications.motherboard_specifications import *
from .specifications.power_supply_specifications import *
from .specifications.processor_specifications import *
